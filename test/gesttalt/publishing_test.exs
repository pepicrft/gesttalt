defmodule Gesttalt.PublishingTest do
  ...
  test "lists only documents owned by the requested publication", %{site: site} do
  ...
  test "updates and publishes a document", %{site: site} do
    post = post_fixture(%{site: site})
  ...
  test "deletes a document", %{site: site} do
    post = post_fixture(%{site: site})
