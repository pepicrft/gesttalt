defmodule GesttaltWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use GesttaltWeb.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Gesttalt.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Gesttalt.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
