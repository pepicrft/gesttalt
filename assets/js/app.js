...
import {hooks as colocatedHooks} from "phoenix-colocated/gesttalt"
import topbar from "../vendor/topbar"
import {ThemePreview, themePreviewConnectParams} from "./theme_preview"

const csrfToken = document.querySelector("meta[name='csrf-token']").getAttribute("content")
const liveSocket = new LiveSocket("/live", Socket, {
  longPollFallbackMs: 2500,
  params: () => ({_csrf_token: csrfToken, ...themePreviewConnectParams()}),
  hooks: {...colocatedHooks, ThemePreview},
})
